  ...
  return (
    <div>
      {listOfFeedItems && isModalOpen && (
        <FeedModal
          content={listOfFeedItems[selectedItemId].content}
      ...
      <div className="feeds-box">
        <div className="feeds-box__header">
          <h1 className="header-primary">
            <a className="header-primary--title" href={feedInfo.link}>
              {feedInfo.title}
            </a>
          </h1>
          ...
          {error ? (
            <div className="error-message">
              ...
              <button
                ...
                onClick={() => getListOfFeedItems(props.url)}
              >
                Ok
              </button>
            </div>
            ...
            <>
              {!listOfFeedItems && <h4>Waiting for server...</h4>}
                      ...
                      >
                        ...
                        <div className="item__title">
                          <h1 className="header-secondary">
                            ...
                            <span
                              className="header-secondary--title"
                              dangerouslySetInnerHTML={{ __html: item.title }}
                            />
                          </h1>
                          <p className="header-secondary--date">
                            {timeDiff(new Date(), new Date(item.pubDate))}
                          </p>
                        </div>
                      </div>
                    );
